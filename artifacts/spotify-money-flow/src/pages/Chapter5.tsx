...
import { artistTiers } from "@/data/spotify";
  ...
  return (
    <div>
      <ChapterHero
        ...
        sub={`~${formatNumber(totalArtists)} artists on Spotify. 1,070 earn over $1M. 7 million earn nothing. The numbers behind streaming's biggest myth - that it is democratising music.`}
        meta='<strong>Source:</strong> <a href="https://loudandclear.byspotify.com/" target="_blank" style="color: #1DB954; text-decoration: none; border-bottom: 1px solid rgba(29,185,84,0.3)">Spotify Loud &amp; Clear 2024</a> &middot; Artist payout data &middot; @$0.004/stream avg'
      />
      ...
      <InsightBox
        ...
        body="1,070 artists earn 1M+ streams per month consistently. 3.5 million earn between $1-$999/year - not enough for a single Spotify subscription. A musician needs 290,000 streams per month just to match a full-time minimum wage, and 950,000 monthly streams to meet the MIT Living Wage for a single adult."
      />
      ...
      <div className="cards-grid">
        <div className="info-card">
          <div className="ic"><Icon name="award" size={22} color="#FFD700" /></div>
        ...
        <div className="info-card">
          <div className="ic"><Icon name="layers" size={22} color="#FF9800" /></div>
          <div className="ttl">The Mid-Tier Reality</div>
        ...
        <div className="info-card">
          <div className="ic"><Icon name="mic" size={22} color="#FF5252" /></div>
        ...
        <div className="info-card">
          <div className="ic"><Icon name="refresh" size={22} color="#64B5F6" /></div>
          <div className="ttl">User-Centric Royalties: The Alternative</div>
          <div className="dsc">Instead of a big pool, your $9.99 would go directly to artists you listen to. Deezer and Soundcloud tried this. Spotify has not adopted it yet.</div>
        </div>
      </div>
      </Reveal>
    </div>
